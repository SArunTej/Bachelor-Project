<%-- 
    Document   : user
    Created on : Nov 29, 2013, 1:04:08 PM
    Author     : Thanu
--%>
...
<ul>
   ...
   <li class='last'><a href='about.jsp'><span>About</span></a></li>
    ...
    <form action ="usercon.jsp" method="POST">
      ...
      <center>  <br> <a href="signup.jsp" accesskey="4" title=""><font color="black">User Registration</a></br>
            </center>
</html>
